...
for t = 1:31;
    ...
    llr_k_1 = log(10.^(llr_k_1));
    llr_k_2 = log(10.^(llr_k_2));
    llr_k_3 = log(10.^(llr_k_3));
    ...
    berest_k_1(t) = sum(1./(1+exp(abs(llr_k_1))))/(2*10^5);
    berest_k_2(t) = sum(1./(1+exp(abs(llr_k_2))))/(4*10^5);
    berest_k_3(t) = sum(1./(1+exp(abs(llr_k_3))))/(6*10^5);
end
